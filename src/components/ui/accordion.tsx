...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronDown className="h-4 w-4 shrink-0 transition-transform duration-200 text-primary-600" />
  </AccordionPrimitive.Trigger>
));
...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Content
    ...
    {...props}
  >
    <div className={cn("pb-4 pt-0 text-secondary-600", className)}>{children}</div>
  </AccordionPrimitive.Content>
));
